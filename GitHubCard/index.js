...
axios.get('https://api.github.com/users/eric-wise')
  .then(data => {
...
const followers = ['cksiazak', 'docoleman36', 'doublebridges', 'pshushereba'];
...
followers.forEach(follower => {
  ...
  .catch(error => {
    console.log("Something is broken for extra cards", error);
  });
});
